...
<html>
    <head>
        ...
        <title>Create EmployeePayrollMaster</title>         
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1>Create EmployeePayrollMaster</h1>
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:employeePayrollMasterInstance,field:'id','errors')}">
                                    <input type="text" id="id" name="id" value="${fieldValue(bean:employeePayrollMasterInstance,field:'id')}" />
                                </td>
                            </tr> 
