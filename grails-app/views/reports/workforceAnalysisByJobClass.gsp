<html>
    <head>
        ...
        <% } %>
        <title>Workforce Analysis By Job Class</title>
    </head>
    <body>
        <div style="-fs-page-sequence: start; page-break-before: avoid">
            ...
            <% } %>
            <h1>Workforce Analysis By Job Class  
            ...
            <% if (!params.pdf) { %>            
            <div class="icons">
                <g:link controller="pdf" action="show" params="[url:'/reports/workforceAnalysisByJobClass',sort:params.sort,order:params.order]" class="pdf" title="Export to PDF" />
                <g:link class="xls" title="Export to Excel" params="[excel:'true']" controller="reports" action="workforceAnalysisByJobClass" />
            </div> 
            <% } %>
            <div class="clear"></div>
            <div class="list">
                <g:render  template="workforceAnalysisByJobClassTable" model="[payrollList:payrollList]"/>
            </div>
