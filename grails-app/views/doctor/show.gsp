            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="doctor.phoneNo.label" default="Phone No" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: doctorInstance, field: "phoneNo")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="doctor.addr.label" default="Addr" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: doctorInstance, field: "addr")}</td>
